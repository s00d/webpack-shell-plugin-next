...
var WebpackShellPlugin = /** @class */ (function () {
    function WebpackShellPlugin(options) {
        ...
        this.onInvalid = function (compilation) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        onBeforeBuild = this.options.onBeforeBuild;
                        if (!onBeforeBuild || typeof onBeforeBuild === 'string')
                            return [2 /*return*/];
        ...
        this.onCompilation = function (compilation) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        onBuildStartOption = this.options.onBuildStart;
                        if (!onBuildStartOption || typeof onBuildStartOption === 'string')
                            return [2 /*return*/];
        ...
        this.onAfterEmit = function (compilation, callback) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        onBuildEndOption = this.options.onBuildEnd;
                        if (!onBuildEndOption || typeof onBuildEndOption === 'string')
                            return [2 /*return*/];
        ...
        this.onDone = function (compilation, callback) { return __awaiter(_this, void 0, void 0, function () {
            var onBuildError, onBuildExitOption;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!compilation.hasErrors()) return [3 /*break*/, 2];
                        onBuildError = this.options.onBuildError;
                        if (!(onBuildError &&
                            typeof onBuildError !== 'string' &&
                            onBuildError.scripts &&
                            onBuildError.scripts.length > 0)) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        onBuildExitOption = this.options.onBuildExit;
                        ...
                        if (!(onBuildExitOption.scripts && onBuildExitOption.scripts.length > 0)) return [3 /*break*/, 4];
                        this.log('Executing additional scripts before exit');
                        return [4 /*yield*/, this.executeScripts(onBuildExitOption.scripts, onBuildExitOption.parallel, onBuildExitOption.blocking)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
    ...
    WebpackShellPlugin.prototype.putsAsync = function (resolve) {
        ...
        return function (error, stdout, stderr) {
            if (error && !_this.options.swallowError) {
                throw error;
            }
            resolve();
        };
    ...
    WebpackShellPlugin.prototype.handleScript = function (script) {
        if (os.platform() === 'win32' || this.options.safe) {
            child_process_1.execSync(script, { maxBuffer: Number.MAX_SAFE_INTEGER, stdio: this.options.logging ? [0, 1, 2] : undefined });
        }
        else {
